...
import { appBanner, cal, check, diamond } from '../../constants/images'
    ...
    return (
        <>
            <section
                ...
                md:items-center"
            >
                <TitleSection title="All-in-one Collaboration and Productivity Platform"
                ...
                >
                    <Button
                        ...
                        className="w-full rounded-[10px] p-6 text-2xl bg-background z-[9999] cursor-pointer"
                    >
                        Get Cypress Free
                    </Button>
                </div>
                ...
                <div className="md:mt-[-90px]
                                ...
                                overflow-hidden"
                                >
                    <Image src={appBanner} alt="App Banner" />
                    <div
            ...
            <section className="relative">
                ...
                >
                        ...
                        {[...Array(2)].map((arr, index) => (
                            <div key={randomUUID()}
                            className={cn("mt-10 flex flex-nowrap gap-6 self-start hover:paused",  {
